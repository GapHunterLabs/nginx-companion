# Privacy Policy — Nginx Companion

**Effective date:** 2026-08-04

Nginx Companion is a Gap Hunter Labs plugin for IntelliJ Platform IDEs.
...
**Nothing.** Nginx Companion does not collect, store, transmit, or sell
...
**None.** Nginx Companion makes zero network calls during normal
...
None. Nginx Companion has no third-party SDKs, no analytics libraries,
